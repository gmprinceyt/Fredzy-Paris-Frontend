...
const Header = ({ user }: { user: User | null }) => {
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8  z-99 font-[Geist] ">
        <header className="flex h-20 w-full shrink-0 items-center px-4 md:px-6">
          ...
          <div className="ml-auto flex gap-2">
            ...
            >
              <b
                className={`absolute -top-1 right-0 border border-gray-400 bg-gray-900 px-1 text-white rounded-full ${
                  cartItems.length
